...
$result = get_CURL('https://www.googleapis.com/youtube/v3/channels?part=snippet,statistics&id=' . $channelId . '&key=AIzaSyBuba_nERG7eLFF0V3kTcaIIxqZuLRDmQU');
...
// latest video
$urlLatestVideo = 'https://www.googleapis.com/youtube/v3/search?key=AIzaSyBuba_nERG7eLFF0V3kTcaIIxqZuLRDmQU&channelId=' . $channelId . '&maxResults=1&order=date&part=snippet';
